...
//   })
//   console.log(answers["25"])
//   // 4 Points if "No" to question 25
//   if (answers["25"] === false) score += 4
//   console.log("Score after question 25: ", score)
...
//   // partner scores
//   "1": 2, "2": 1, "3": 3, "4": 3, "5": 3,
//   "6": 2, "6a": 1, "7": 1, "8": 1, "9": 1,
//   "10": 1, "11": 1, "11a": 1, "12": 1, "13": 1,
//   "14": 1, "14a": 2, "15": 1, "16": 1, "16a": 1,
//   "17": 1, "18": 1, "19": 1, "20": 1, "20a": 1,
//   "21": 1, "22": 1, "23": 1, "24": 1,
//   "25": 4, // if false
//   "26": 5, // if false
//   "27": 0, // ignored
...
// function calculateScoreFromQuestions(
...
//     else if (typeof ans === "boolean" && ans === true) score = scoreConfig[qid] ?? 0
